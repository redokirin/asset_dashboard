    ...
    <div class="space-y-5">
        ...
        <div class="rounded-xl bg-gray-800 border border-gray-700/50 p-4 space-y-3">
            ...
            <div class="flex gap-2">
                <input v-model="inputText" type="text" placeholder="2330.TW 6284.TWO VOO"
                ...
                <button @click="runAnalysis" :disabled="loading || !inputText.trim()"
        ...
        <div v-if="!loading && results.length" class="space-y-4">
            <div v-for="res in results" :key="res['代碼']"
                ...
                <div class="px-4 py-3 flex items-center justify-between border-b border-gray-700/40">
                    <div class="flex items-center gap-2.5">
                        <button class="font-mono text-blue-400 hover:underline text-sm font-semibold transition-colors"
                            @click="openChart(res)">{{ res['代碼'] }}</button>
                ...
                <div class="px-4 pb-3 flex justify-end">
                    ...
                    <button
                        ...
                        :disabled="copyState[res['代碼']] === 'loading'" @click="copyReport(res)">
